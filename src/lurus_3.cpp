/*  Program untuk terbang lurus dengan tiga ardrones
...
//gerak mundur
  ...
  pub_twist1 = node.advertise<geometry_msgs::Twist>("/ardrone1/ardrone/cmd_vel", 1); /* Message queue length is just 1 */
	...
	pub_twist3 = node.advertise<geometry_msgs::Twist>("/ardrone3/ardrone/cmd_vel", 1); /* Message queue length is just 1 */
	...
	pub_empty_takeoff3 = node.advertise<std_msgs::Empty>("/ardrone3/ardrone/takeoff", 1); /* Message queue length is just 1 */
	...
	pub_empty_land3 = node.advertise<std_msgs::Empty>("/ardrone3/ardrone/land", 1); /* Message queue length is just 1 */
  ...
  pub_empty_reset3 = node.advertise<std_msgs::Empty>("/ardrone3/ardrone/reset", 1); /* Message queue length is just 1 */
